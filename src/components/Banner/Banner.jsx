    ...
    <div className="flex gap-15 py-15 items-center justify-between max-w-[80%] mx-auto">
      <div className="flex flex-col gap-4">
        ...
        <div className="flex mt-8 gap-4">
          <button className="btn bg-linear-to-r from-[#4F39F6] to-[#9514FA] rounded-[100px] py-3 px-4 text-white">
            Explore Products
          </button>
          <button className="btn p-[1.5px] rounded-[100px] bg-linear-to-r from-[#4F39F6] to-[#9514FA] border-none">
